...
function validateEndpoint(req, res, endpoint, statusOptions) {
  ...
  if (
    !(
      (endpoint === null || endpoint === void 0 ? void 0 : endpoint.length) ||
      ((_a = req.url) === null || _a === void 0 ? void 0 : _a.length)
    ) ||
    !req.url
  ) {
...
const server = createServer((req, res) => {
  var _a;
  let endpoint = ((_a = req.url) === null || _a === void 0
    ? void 0
    : _a.split("/")) || [""];
  endpoint =
    endpoint === null || endpoint === void 0
      ? void 0
      : endpoint.filter((point) => {
          return point.length;
        });
